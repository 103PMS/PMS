       ...
       <fieldset>
         ...
         <div>
           ...
           <s:iterator value="departList">
                <tr>
                <td><input type="checkbox" class="checkbox" name="id" value="<s:property value="depart_id"/>"/></td>
                <td><%=++i %></td>
                <td><s:property value="depart_name"/></td>
                <td><s:property value="user.user_name"/></td>
                <td><s:property value="depart_phone"/></td>
                <td><a href="depart_check.action?id=${depart_id}" class="like_btn">查看</a>&nbsp;|&nbsp;<a href="depart_edit.action?id=${depart_id}" class="like_btn">编辑</a></td>
             </s:iterator>
                </tr>
