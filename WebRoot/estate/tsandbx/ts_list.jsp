...
<body onload="SelectCBox()">
    ...
    <div id="div_table">
       <fieldset>
         <legend>我的投诉列表--未处理</legend>
         
         <div class="search">
           <from action="" method="">
           	   按投诉主题搜索：<input type="text" name="">
           ...
           <table>
              <tr>
                ...
                <td>1</td>
                <th>第1幛101</th>
                <td><a href="<%=path %>/estate/tsandbx/ts_check.jsp">暖气坏了</a></td>
                <td>2013-12-11 17:45:04</td>
                <td>未处理</td>
                <td><a href="<%=path %>/estate/tsandbx/ts_edit.jsp" class="like_btn">修改</a></td>
